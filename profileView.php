                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadProduct.php" class="button fit" style="text-decoration: none;width:180px;">Upload Product</a>
            						</div>
                                    <div class="3u 12u$(large)">
                                        <a href="Login/logout.php" class="button fit" style="text-decoration: none;width:180px;">LOG OUT</a>
                                    </div>
                                </div>
                            </center>
                        </div>
