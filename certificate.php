    			...
    			<div class="card-body p-0">
    				<div class="invoice-container">
    					<div class="invoice-header">
    						...
    						<div class="row gutters">
    							...
    							<div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    No. 363, 19th main road, 1st Block Rajajinagar <br>
                                    Bangalore- 560010<br>
    									98765 43210
    								</address>
    							</div>
    						...
    						<div class="row gutters">
    							<div class="col-lg-12 col-md-12 col-sm-12">
    								<div class="table-responsive">
                                        ...
                                        <h3><center>Due to your kind donation of Rs.<?php echo $_POST["amount"]; ?>, We were able to put up <?php echo $_POST["amount"]; ?> trees.<br> </h3>
    								</div>
    							</div>
    						</div>
    						<!-- Row end -->
    					...
    					<div class="invoice-footer">
    						Thank you for your Donation. Please do encourage your friends and family to donate for this great cause.
    					</div>
